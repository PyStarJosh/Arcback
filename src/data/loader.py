...
class Loader:
    ...
    def _adjust_raw_stock_data(self, r, symbol):
        adjusted_stock_data = {}
    ...
    def _call_api(self, url, symbol=None):
        try:
            ...
            if symbol and symbol.upper() in self.SUPPORTED_STOCK_SYMBOLS:
                return self._adjust_raw_stock_data(data_json, symbol.upper())
            return data_json
    ...
    def get_raw_crypto_data(self, symbol, market):
    ...
    def get_raw_gold_data(self, interval):
    ...
    def get_raw_silver_data(self, interval):
    ...
    def get_raw_commodities_data(self, commodity_type, interval):        
